...
[[maybe_unused]] const char* const k_asset_strings[] = {
    ...
    QT_TRANSLATE_NOOP("Missions", "Cut and carry home four hundred of timber and two hundred and ten of stone. The near stand will not cover it; the deep pines will."),
    ...
    QT_TRANSLATE_NOOP("Missions", "Fill the levy out of the Pinewater cut: four hundred of timber and two hundred and ten of stone, cut and carried home before the column comes back through."),
    ...
    QT_TRANSLATE_NOOP("Missions", "Four hundred of timber and two hundred of stone, and the near stand was stripped by the last detail. That means the deep pines, which means the long road, which means whatever is living in the deep pines gets a look at us. Split the crew. Escort the far one."),
    ...
    QT_TRANSLATE_NOOP("Missions", "Leave the axes. Leave the carts. A detail that cannot walk out of its own cut does not get to carry anything."),
