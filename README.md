...
The AudioCraft-generated music that used to restrict the game to non-commercial
use has been replaced; the current tracks were generated under a licence the
project author holds. Confirm the terms recorded in the music section of
THIRD_PARTY_LICENSES.md before any paid release.
