...
The important exception is the bundled music: its AudioCraft model weights are
licensed **CC BY-NC 4.0**, so the music is restricted to non-commercial use.
Selling the game or including it in a commercial product requires replacing
those tracks first.
