...
public:
  MountedPoseController(HumanoidPose& pose, const HumanoidAnimationContext& anim_ctx);

  void mount_on_horse(const MountedAttachmentFrame& mount);
  void dismount();

  void riding_idle(const MountedAttachmentFrame& mount);
  void riding_leaning(const MountedAttachmentFrame& mount,
                      float forward_lean,
                      float side_lean);
  void riding_charging(const MountedAttachmentFrame& mount, float intensity);
  void riding_reining(const MountedAttachmentFrame& mount,
                      float left_tension,
                      float right_tension);

  void riding_melee_strike(const MountedAttachmentFrame& mount, float attack_phase);
  void riding_spear_thrust(const MountedAttachmentFrame& mount, float attack_phase);
  ...
  void hold_reins(const MountedAttachmentFrame& mount,
                  float left_slack,
                  float right_slack,
...
private:
  ...
  void apply_sword_strike(const MountedAttachmentFrame& mount,
                          float attack_phase,
                          bool keep_left_hand);
  void apply_spear_thrust(const MountedAttachmentFrame& mount, float attack_phase);
  ...
  void hold_reins_impl(const MountedAttachmentFrame& mount,
                       float left_slack,
                       float right_slack,
                       float left_tension,
                       float right_tension,
