...
[[nodiscard]] auto socket_def(HumanoidSocket socket) noexcept -> const SocketDef&;
...
using HumanoidSkeletonSchemaHash = std::uint64_t;

[[nodiscard]] auto
humanoid_skeleton_schema_hash() noexcept -> HumanoidSkeletonSchemaHash;
