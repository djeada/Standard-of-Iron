...
struct HumanProportions {
  ...
  static constexpr float SHOULDER_WIDTH = HEAD_HEIGHT * 2.10F;
  static constexpr float HEAD_RADIUS = HEAD_HEIGHT * 0.41F;
  static constexpr float NECK_RADIUS = HEAD_RADIUS * 0.39F;
  static constexpr float TORSO_TOP_R = HEAD_RADIUS * 1.45F;
  static constexpr float TORSO_BOT_R = HEAD_RADIUS * 1.12F;
  static constexpr float UPPER_ARM_R = HEAD_RADIUS * 0.50F;
  static constexpr float FORE_ARM_R = HEAD_RADIUS * 0.36F;
  static constexpr float HAND_RADIUS = HEAD_RADIUS * 0.28F;
  static constexpr float UPPER_LEG_R = HEAD_RADIUS * 0.72F;
