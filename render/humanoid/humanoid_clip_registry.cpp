...
auto build_sway_clips() -> std::vector<Clip> {
  ...
  clips[static_cast<std::size_t>(HumanoidState::Idle)] = Clip("humanoid_idle_sway",
                                                              {KF{0.00F, 0.00F},
                                                               KF{0.60F, 0.018F},
                                                               KF{1.20F, 0.00F},
                                                               KF{1.80F, -0.018F},
                                                               KF{2.40F, 0.00F}});
  clips[static_cast<std::size_t>(HumanoidState::Hold)] = Clip("humanoid_hold_sway",
                                                              {KF{0.00F, 0.00F},
                                                               KF{1.00F, 0.008F},
                                                               KF{2.00F, 0.00F},
                                                               KF{3.00F, -0.008F},
                                                               KF{4.00F, 0.00F}});
  clips[static_cast<std::size_t>(HumanoidState::Walk)] = Clip("humanoid_walk_sway",
                                                              {KF{0.00F, 0.00F},
                                                               KF{0.25F, 0.05F},
                                                               KF{0.50F, 0.00F},
                                                               KF{0.75F, -0.05F},
                                                               KF{1.00F, 0.00F}});
  clips[static_cast<std::size_t>(HumanoidState::Run)] = Clip("humanoid_run_sway",
                                                             {KF{0.00F, 0.00F},
                                                              KF{0.15F, 0.08F},
                                                              KF{0.30F, 0.00F},
                                                              KF{0.45F, -0.08F},
  ...
  clips[static_cast<std::size_t>(HumanoidState::AttackMelee)] =
      Clip("humanoid_melee_sway",
           {KF{0.00F, 0.00F}, KF{0.30F, 0.02F}, KF{0.60F, -0.02F}, KF{0.90F, 0.00F}});
  clips[static_cast<std::size_t>(HumanoidState::AttackRanged)] =
      Clip("humanoid_ranged_sway",
           {KF{0.00F, 0.00F}, KF{0.50F, 0.01F}, KF{1.00F, -0.01F}, KF{1.50F, 0.00F}});
...
auto HumanoidClipDriver::sample(float time) const -> HumanoidOverlays {
  ...
  Render::Animation::ChannelEvaluator<float> jitter_eval(m_registry->jitter_clips(),
                                                         &m_state.raw());

  HumanoidOverlays out;
  out.torso_sway_x = sway_eval.sample(time, Render::Animation::WrapMode::Loop);
  out.breathing_y = breathing_eval.sample(time, Render::Animation::WrapMode::Loop);
  out.hand_jitter_amp = jitter_eval.sample(time, Render::Animation::WrapMode::Loop);
  return out;
}
