...
void ArmorLightCarthageRenderer::render(const DrawContext &ctx,
  ...
  batch.meshes.push_back({torso_mesh != nullptr ? torso_mesh : get_unit_torso(),
                          nullptr, cuirass, metal_color, nullptr, 1.0F, 1});
  ...
  batch.meshes.push_back({torso_mesh != nullptr ? torso_mesh : get_unit_torso(),
                          nullptr, front_panel, cloth_accent, nullptr, 1.0F,
                          1});
  ...
  batch.meshes.push_back({torso_mesh != nullptr ? torso_mesh : get_unit_torso(),
                          nullptr, back_panel, metal_core, nullptr, 1.0F, 1});
}
