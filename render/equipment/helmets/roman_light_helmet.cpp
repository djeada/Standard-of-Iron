...
void RomanLightHelmetRenderer::submit(const RomanLightHelmetConfig&,
  ...
  append_humanoid_attachment_archetype(
      batch, ctx, frames.head, roman_light_helmet_archetype(), colors);
}
