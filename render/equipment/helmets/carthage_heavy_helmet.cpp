...
void CarthageHeavyHelmetRenderer::render_bowl(const DrawContext &ctx,
  ...
  QVector3D c0 = headPoint(QVector3D(0.0f, 1.22f, 0.0f));
  ...
  QVector3D rimCenter = headPoint(QVector3D(0.0f, 0.92f, 0.0f));
...
void CarthageHeavyHelmetRenderer::render_cheek_guards(
  ...
  QVector3D left_cheek = headPoint(QVector3D(-0.58f, 0.48f, 0.42f));
  QVector3D right_cheek = headPoint(QVector3D(0.58f, 0.48f, 0.42f));
...
void CarthageHeavyHelmetRenderer::render_face_plate(const DrawContext &ctx,
  ...
  QVector3D brow = headPoint(QVector3D(0.0f, 1.00f, 0.60f));
  QVector3D chin = headPoint(QVector3D(0.0f, 0.22f, 0.34f));
  QMatrix4x4 mask =
  ...
  QVector3D noseTop = headPoint(QVector3D(0.0f, 0.88f, 0.70f));
  QVector3D noseBottom = headPoint(QVector3D(0.0f, 0.28f, 0.46f));
...
void CarthageHeavyHelmetRenderer::render_neck_guard(const DrawContext &ctx,
  ...
  QVector3D guardCenter = headPoint(QVector3D(0.0f, 0.45f, -0.65f));
...
void CarthageHeavyHelmetRenderer::render_brow_arch(const DrawContext &ctx,
  ...
  QVector3D left = headPoint(QVector3D(-0.62f, 0.96f, 0.60f));
  QVector3D right = headPoint(QVector3D(0.62f, 0.96f, 0.60f));
  ...
  QVector3D ridgeTop = headPoint(QVector3D(0.0f, 1.12f, 0.58f));
...
void CarthageHeavyHelmetRenderer::render_crest(const DrawContext &ctx,
  ...
  QVector3D crestBack = headPoint(QVector3D(0.0f, 1.48f, -0.28f));
  QVector3D crestFront = headPoint(QVector3D(0.0f, 1.48f, 0.28f));
  ...
  QVector3D plumeTop = headPoint(QVector3D(0.0f, 2.00f, 0.0f));
  QVector3D plumeBase = headPoint(QVector3D(0.0f, 1.38f, 0.0f));
