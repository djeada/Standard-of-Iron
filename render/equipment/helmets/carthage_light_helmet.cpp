  ...
  static const RenderArchetype archetype = [] {
    std::array<GeneratedEquipmentPrimitive, 1> const primitives{{
        generated_cylinder(QVector3D(0.0F, -0.30F, -0.96F),
                           QVector3D(0.0F, -0.12F, -1.00F),
                           1.36F,
                           k_metal_dark_slot,
                           1.0F,
                           2),
    }};
    return build_generated_equipment_archetype("carthage_light_neck_guard", primitives);
  }();
  return archetype;
}
  ...
  static const RenderArchetype archetype = [] {
    std::array<GeneratedEquipmentPrimitive, 4> const primitives{{
        generated_cylinder(QVector3D(-1.44F, 0.06F, 0.20F),
                           QVector3D(-1.48F, -0.18F, 0.28F),
                           0.19F,
                           k_metal_dark_slot,
                           1.0F,
                           2),
        generated_cylinder(QVector3D(-1.48F, -0.18F, 0.28F),
                           QVector3D(-1.28F, -0.38F, 0.36F),
                           0.16F,
                           k_metal_dark_slot,
                           1.0F,
                           2),
...
auto carthage_light_helmet_crest_archetype(bool high_detail) -> const RenderArchetype& {
  static const RenderArchetype low_detail = [] {
    ...
    primitives[0] =
        generated_cylinder(crest_front, crest_back, 0.044F, k_metal_slot, 1.0F, 2);
    ...
    for (int i = 0; i < 8; ++i) {
      ...
      primitives[1 + i] = generated_cylinder(base, tip, 0.048F, k_crest_slot, 0.90F, 0);
    }

    return build_generated_equipment_archetype("carthage_light_crest_low", primitives);
  }();
  ...
  static const RenderArchetype high_detail_archetype = [] {
    ...
    return build_generated_equipment_archetype("carthage_light_crest_high", primitives);
  }();
...
auto carthage_light_helmet_rivets_archetype() -> const RenderArchetype& {
  static const RenderArchetype archetype = [] {
    std::array<GeneratedEquipmentPrimitive, 5> const primitives{{
        generated_sphere(QVector3D(-0.50F, 0.46F, 0.64F), 0.05F, k_metal_slot, 1.0F, 2),
        generated_sphere(QVector3D(-0.25F, 0.46F, 0.64F), 0.05F, k_metal_slot, 1.0F, 2),
        generated_sphere(QVector3D(0.0F, 0.46F, 0.64F), 0.05F, k_metal_slot, 1.0F, 2),
        generated_sphere(QVector3D(0.25F, 0.46F, 0.64F), 0.05F, k_metal_slot, 1.0F, 2),
        generated_sphere(QVector3D(0.50F, 0.46F, 0.64F), 0.05F, k_metal_slot, 1.0F, 2),
    }};
    return build_generated_equipment_archetype("carthage_light_rivets", primitives);
  }();
  return archetype;
}
...
auto carthage_light_helmet_make_static_attachment(
    const RenderArchetype& sub_archetype,
...
void CarthageLightHelmetRenderer::submit(const CarthageLightHelmetConfig& config,
  ...
  append_humanoid_attachment_archetype(batch,
                                       ctx,
                                       frames.head,
                                       carthage_light_helmet_neck_guard_archetype(),
                                       equipment_palette,
                                       k_helmet_local_offset,
                                       k_helmet_uniform_scale);
  append_humanoid_attachment_archetype(batch,
                                       ctx,
                                       frames.head,
                                       carthage_light_helmet_cheek_guards_archetype(),
                                       equipment_palette,
                                       k_helmet_local_offset,
                                       k_helmet_uniform_scale);
  ...
  if (config.has_nasal_guard) {
    append_humanoid_attachment_archetype(batch,
                                         ctx,
                                         frames.head,
                                         carthage_light_helmet_nasal_guard_archetype(),
                                         equipment_palette,
                                         k_helmet_local_offset,
                                         k_helmet_uniform_scale);
  }
  ...
  if (config.detail_level > 0) {
    append_humanoid_attachment_archetype(batch,
                                         ctx,
                                         frames.head,
                                         carthage_light_helmet_rivets_archetype(),
                                         equipment_palette,
                                         k_helmet_local_offset,
                                         k_helmet_uniform_scale);
  }
