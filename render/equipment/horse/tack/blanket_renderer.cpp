...
void BlanketRenderer::render(const DrawContext &ctx,
  ...
  batch.meshes.push_back({get_unit_sphere(), nullptr, blanket_transform, variant.blanket_color, nullptr,
           1.0F});
  ...
  for (int i = 0; i < 2; ++i) {
    ...
    batch.meshes.push_back({get_unit_sphere(), nullptr, drape, variant.blanket_color, nullptr, 1.0F, 4});
  }
}
