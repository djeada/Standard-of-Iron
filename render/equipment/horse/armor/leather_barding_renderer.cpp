...
auto leather_barding_chest_archetype() -> const RenderArchetype& {
  static const RenderArchetype archetype = [] {
    ...
    builder.add_palette_mesh(
        get_unit_sphere(),
        box_local_model(QVector3D(0.0F, -0.03F, 0.0F), QVector3D(0.38F, 0.28F, 0.32F)),
        k_barding_slot,
        nullptr,
        1.0F,
        1);
...
auto leather_barding_barrel_archetype() -> const RenderArchetype& {
  static const RenderArchetype archetype = [] {
    ...
    builder.add_palette_mesh(
        get_unit_sphere(),
        box_local_model(QVector3D(0.32F, -0.08F, 0.0F), QVector3D(0.10F, 0.25F, 0.45F)),
        k_barding_slot,
        nullptr,
        1.0F,
        1);
...
auto leather_barding_make_static_attachment(const RenderArchetype& archetype,
...
void LeatherBardingRenderer::submit(const DrawContext& ctx,
  ...
  append_horse_attachment_archetype(
      batch, ctx, frames.chest, leather_barding_chest_archetype(), palette);
  append_horse_attachment_archetype(
