...
void CrupperRenderer::render(const DrawContext &ctx,
  ...
  batch.meshes.push_back({get_unit_sphere(), nullptr, rear_plate, armor_color, nullptr, 1.0F, 1});
  ...
  for (int i = 0; i < 2; ++i) {
    ...
    batch.meshes.push_back({get_unit_sphere(), nullptr, side_plate, armor_color * 0.95F, nullptr, 1.0F,
             1});
  }
}
