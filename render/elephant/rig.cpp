...
void ElephantRendererBase::render_full(
  ...
  Render::Elephant::prepare_elephant_full(*this, ctx, anim, profile,
                                          shared_howdah, shared_motion, prep);
...
void ElephantRendererBase::render_simplified(
    ...
    const ElephantMotionSample *shared_motion, ISubmitter &out) const {
  Render::Elephant::ElephantPreparation prep;
  Render::Elephant::prepare_elephant_simplified(
      *this, ctx, anim, profile, shared_howdah, shared_motion, prep);
...
void ElephantRendererBase::render_minimal(
    ...
    const ElephantMotionSample *shared_motion, ISubmitter &out) const {
  Render::Elephant::ElephantPreparation prep;
  Render::Elephant::prepare_elephant_minimal(*this, ctx, profile, shared_motion,
                                             prep);
