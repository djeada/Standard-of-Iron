...
auto build_marketplace_archetype(BuildingState state) -> RenderArchetype {
  ...
  desc.add_box(QVector3D(0.0F, 0.06F, 0.0F), QVector3D(1.2F, 0.06F, 1.2F), c.stone_base);

  float const counter_h = 0.4F * height_multiplier;
  desc.add_box(QVector3D(-0.4F, counter_h, 0.0F), QVector3D(0.6F, 0.05F, 0.8F), c.cedar);

  float const post_h = 0.8F * height_multiplier;
  desc.add_box(QVector3D(-0.85F, post_h * 0.5F, -0.7F), QVector3D(0.04F, post_h * 0.5F, 0.04F), c.cedar_dark);
  desc.add_box(QVector3D(-0.85F, post_h * 0.5F, 0.7F), QVector3D(0.04F, post_h * 0.5F, 0.04F), c.cedar_dark);
  desc.add_box(QVector3D(0.05F, post_h * 0.5F, -0.7F), QVector3D(0.04F, post_h * 0.5F, 0.04F), c.cedar_dark);
  desc.add_box(QVector3D(0.05F, post_h * 0.5F, 0.7F), QVector3D(0.04F, post_h * 0.5F, 0.04F), c.cedar_dark);

  float const awning_y = post_h + 0.04F;
  desc.add_box(QVector3D(-0.4F, awning_y, 0.0F), QVector3D(0.55F, 0.02F, 0.8F), c.cloth_red,
               BuildingStateMask::Normal | BuildingStateMask::Damaged);

  desc.add_box(QVector3D(-0.4F, awning_y - 0.03F, 0.78F), QVector3D(0.55F, 0.02F, 0.04F), c.cloth_gold,
               BuildingStateMask::Normal | BuildingStateMask::Damaged);

  float const wall_h = 0.6F * height_multiplier;
  desc.add_box(QVector3D(0.8F, wall_h * 0.5F + 0.12F, 0.0F), QVector3D(0.1F, wall_h * 0.5F, 0.9F), c.limestone);

  desc.add_palette_box(QVector3D(0.92F, 0.5F * height_multiplier, 0.0F),
                       QVector3D(0.02F, 0.2F, 0.12F), k_marketplace_team_slot,
                       BuildingStateMask::Normal | BuildingStateMask::Damaged);
