...
auto register_horse_spearman_rider_archetype()
  ...
  static const std::array<Render::Creature::StaticAttachmentSpec, 13>
      k_attachments{
          ...
          Render::GL::spear_make_static_attachments(
              k_canonical_spear_cfg, k_hand_r_bone, k_spear_base_role_byte,
              k_hand_r_bind_matrix, k_hand_r_bind_right)[0],
          Render::GL::spear_make_static_attachments(
              k_canonical_spear_cfg, k_hand_r_bone, k_spear_base_role_byte,
              k_hand_r_bind_matrix, k_hand_r_bind_right)[1],
          Render::GL::spear_make_static_attachments(
              k_canonical_spear_cfg, k_hand_r_bone, k_spear_base_role_byte,
              k_hand_r_bind_matrix, k_hand_r_bind_right)[2],
          Render::GL::spear_make_static_attachments(
              k_canonical_spear_cfg, k_hand_r_bone, k_spear_base_role_byte,
              k_hand_r_bind_matrix, k_hand_r_bind_right)[3],
