        ...
        EquipmentRecord{
            .dispatch =
                [](const EquipmentSubmitContext &sub,
                  ...
                  draw_headwrap_into(*sub.ctx, *sub.frames, batch);
                },
        },
        ...
        EquipmentRecord{
            .dispatch =
                [](const EquipmentSubmitContext &sub,
                  ...
                  draw_craftsman_robes_into(*sub.ctx, *sub.palette, *sub.frames,
                                            sub.seed, batch);
                },
        },
        ...
        EquipmentRecord{
            .dispatch =
                [](const EquipmentSubmitContext &sub,
                  ...
                  WorkApronRenderer::submit(work_apron_cfg, *sub.ctx,
                                            *sub.frames, *sub.palette,
                                            *sub.anim, batch);
                },
        },
        ...
        EquipmentRecord{
            .dispatch =
                [](const EquipmentSubmitContext &sub,
                  ...
                  ToolBeltRenderer::submit(tool_belt_cfg, *sub.ctx, *sub.frames,
        ...
        EquipmentRecord{
            .dispatch =
                [](const EquipmentSubmitContext &sub,
                  ...
                  ArmGuardsRenderer::submit(arm_guards_cfg, *sub.ctx,
                                            *sub.frames, *sub.palette,
                                            *sub.anim, batch);
                },
        },
        ...
        EquipmentRecord{
            .dispatch =
                [](const EquipmentSubmitContext &sub,
                  ...
                  draw_stone_hammer_into(*sub.ctx, *sub.palette, *sub.frames,
                                         sub.anim->inputs, batch);
                },
        },
    };
