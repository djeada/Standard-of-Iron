...
auto prepare_mounted_rows(const Render::Creature::Pipeline::MountedSpec& mounted_spec,
  ...
  set.mount_row = Render::Creature::Pipeline::make_prepared_creature_row(
      ...
      mount_world_from_unit,
      seed,
      lod,
      0,
      pass);
  set.rider_row =
      Render::Creature::Pipeline::make_prepared_humanoid_row(mounted_spec.rider,
                                                             rider_pose,
                                                             rider_variant,
                                                             rider_anim,
                                                             rider_world_from_unit,
                                                             seed,
                                                             lod,
                                                             0,
                                                             pass);
