...
class AbandonedHomeRenderer : public IRenderPass {
public:
...
private:
  ...
  QVector3D m_light_direction = AbandonedHomeBatchParams::default_light_direction();

  Render::Ground::Scatter::FilteredRendererState<AbandonedHomeInstanceGpu,
                                                 AbandonedHomeBatchParams>
      m_state;
};
