...
class StatueRenderer : public IRenderPass {
public:
  StatueRenderer();
...
private:
  ...
  QVector3D m_light_direction = StatueBatchParams::default_light_direction();

  Render::Ground::Scatter::FilteredRendererState<StatueInstanceGpu, StatueBatchParams>
      m_state;
};
