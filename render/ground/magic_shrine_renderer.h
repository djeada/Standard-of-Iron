...
class MagicShrineRenderer : public IRenderPass {
public:
  MagicShrineRenderer();
  ~MagicShrineRenderer() override;
...
private:
  ...
  QVector3D m_light_direction = MagicShrineBatchParams::default_light_direction();

  Render::Ground::Scatter::FilteredRendererState<MagicShrineInstanceGpu,
                                                 MagicShrineBatchParams>
      m_state;
};
