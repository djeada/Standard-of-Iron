...
public:
  ...
  [[nodiscard]] bool is_gpu_ready() const { return m_plant_state.is_gpu_ready(); }
  ...
  [[nodiscard]] auto last_sync_stats() const -> Render::Ground::Scatter::SyncStats {
    return m_plant_state.last_sync_stats;
  }
...
private:
  ...
  Render::Ground::Scatter::FilteredRendererState<PlantInstanceGpu, PlantBatchParams>
      m_plant_state;
};
