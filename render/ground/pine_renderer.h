...
public:
  ...
  [[nodiscard]] bool is_gpu_ready() const { return m_pine_state.is_gpu_ready(); }
...
private:
  ...
  Render::Ground::Scatter::FilteredRendererState<PineInstanceGpu, PineBatchParams>
      m_pine_state;
};
