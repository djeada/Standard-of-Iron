...
class RuinsRenderer : public IRenderPass {
public:
  RuinsRenderer();
...
private:
  ...
  QVector3D m_light_direction = RuinsBatchParams::default_light_direction();

  Render::Ground::Scatter::FilteredRendererState<RuinsInstanceGpu, RuinsBatchParams>
      m_state;
};
