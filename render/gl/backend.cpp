  ...
  while (i < count) {
    ...
    case StoneBatchCmdIndex: {
      if (m_vegetationPipeline) {
        m_vegetationPipeline->render_stones(queue, i, view_proj, this);
      }
      break;
    }
    case PlantBatchCmdIndex: {
      if (m_vegetationPipeline) {
        m_vegetationPipeline->render_plants(queue, i, view_proj, this);
      }
      break;
    }
    case PineBatchCmdIndex: {
      if (m_vegetationPipeline) {
        m_vegetationPipeline->render_pines(queue, i, view_proj, this);
      }
      break;
    }
    case OliveBatchCmdIndex: {
      if (m_vegetationPipeline) {
        m_vegetationPipeline->render_olives(queue, i, view_proj, this);
      }
      break;
    }
    case FireCampBatchCmdIndex: {
      if (m_vegetationPipeline) {
        m_vegetationPipeline->render_firecamps(queue, i, cam, view_proj, this);
      }
      break;
    }
    ...
    case TerrainChunkCmdIndex: {
      if (m_terrainPipeline) {
        m_terrainPipeline->render_terrain_chunk(queue, i, view_proj, this);
      }
      break;
    }
    case MeshCmdIndex: {
