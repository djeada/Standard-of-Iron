...
part_graph_for(const CreatureSpec& spec, CreatureLOD lod) noexcept -> const PartGraph& {
  switch (lod) {
...
inline auto
submit_creature(const CreatureSpec& spec,
  ...
  return submit_part_graph(spec.topology,
                           part_graph_for(spec, lod),
                           palette,
                           lod,
                           world_from_unit,
                           out,
...
[[nodiscard]] auto validate_creature_spec(const CreatureSpec& spec) noexcept -> bool;
