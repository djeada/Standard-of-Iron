...
inline constexpr PartDef k_parts[] = {
    ...
    {PartKind::Box, 0, 0xFFU, PaletteSlot::Literal, C::k_limestone,
     Platform_TopLow, Platform_TopHigh, k_invalid_scalar, 1.0F, 1.0F, 1.0F,
     1.0F, 1.0F},
    ...
    {PartKind::Box, 0, 0xFFU, PaletteSlot::Literal, C::k_blue_accent,
     Court_PoolTrimSLow, Court_PoolTrimSHigh, k_invalid_scalar, 1.0F, 1.0F,
     1.0F, 1.0F, 1.0F},
    {PartKind::Box, 0, 0xFFU, PaletteSlot::Literal, C::k_blue_accent,
     Court_PoolTrimNLow, Court_PoolTrimNHigh, k_invalid_scalar, 1.0F, 1.0F,
     1.0F, 1.0F, 1.0F},
    {PartKind::Cylinder, 0, 0xFFU, PaletteSlot::Literal, C::k_marble,
     Court_PillarBot, Court_PillarTop, k_invalid_scalar, 0.06F, 1.0F, 1.0F,
     1.0F, 1.0F},
    {PartKind::Box, 0, 0xFFU, PaletteSlot::Literal, C::k_blue_accent,
     Court_PillarCapLow, Court_PillarCapHigh, k_invalid_scalar, 1.0F, 1.0F,
     1.0F, 1.0F, 1.0F},

    {PartKind::Box, 0, 0xFFU, PaletteSlot::Literal, C::k_limestone,
     Wall_BackLow, Wall_BackHigh, k_invalid_scalar, 1.0F, 1.0F, 1.0F, 1.0F,
     1.0F},
    {PartKind::Box, 0, 0xFFU, PaletteSlot::Literal, C::k_limestone,
     Wall_LeftLow, Wall_LeftHigh, k_invalid_scalar, 1.0F, 1.0F, 1.0F, 1.0F,
     1.0F},
    {PartKind::Box, 0, 0xFFU, PaletteSlot::Literal, C::k_limestone,
    ...
    {PartKind::Box, 0, 0xFFU, PaletteSlot::Literal, C::k_cedar_dark,
     ...
     1.0F},
    {PartKind::Box, 0, 0xFFU, PaletteSlot::Literal, C::k_blue_accent,
     Door_LLintelLow, Door_LLintelHigh, k_invalid_scalar, 1.0F, 1.0F, 1.0F,
     1.0F, 1.0F},
    {PartKind::Box, 0, 0xFFU, PaletteSlot::Literal, C::k_cedar_dark,
     Door_RDoorLow, Door_RDoorHigh, k_invalid_scalar, 1.0F, 1.0F, 1.0F, 1.0F,
     1.0F},
    {PartKind::Box, 0, 0xFFU, PaletteSlot::Literal, C::k_blue_accent,
     Door_RLintelLow, Door_RLintelHigh, k_invalid_scalar, 1.0F, 1.0F, 1.0F,
     1.0F, 1.0F},
