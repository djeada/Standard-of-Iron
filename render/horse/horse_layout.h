...
inline constexpr float k_horse_head_visual_width_scale = 1.56F;
inline constexpr float k_horse_head_visual_height_scale = 1.29675F;
inline constexpr float k_horse_head_visual_length_scale = 1.56F;
