...
void HorseRendererBase::render_full(
  ...
  Render::Horse::prepare_horse_full(*this, ctx, anim, rider_ctx, profile,
                                    shared_mount, shared_reins, shared_motion,
                                    horse_loadout, sub_ctx_template, prep);
...
void HorseRendererBase::render_simplified(
  ...
  Render::Horse::HorsePreparation prep;
  Render::Horse::prepare_horse_simplified(*this, ctx, anim, rider_ctx, profile,
                                          shared_mount, shared_motion, prep);
...
void HorseRendererBase::render_minimal(const DrawContext &ctx,
  ...
  Render::Horse::HorsePreparation prep;
  Render::Horse::prepare_horse_minimal(*this, ctx, profile, shared_motion,
                                       prep);
