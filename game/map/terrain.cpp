...
constexpr int k_hill_ramp_extra_steps = 24;

constexpr float k_hill_ramp_steepness_exponent = 0.85F;
...
constexpr float k_entry_outward_steps_fraction = 0.0F;
constexpr int k_entry_outward_steps_min = 0;
constexpr int k_entry_outward_steps_max = 0;
