...
inline constexpr const char* TREE_MIX = "tree_mix";
inline constexpr const char* SPAWN_EDGE_PADDING = "spawn_edge_padding";
inline constexpr const char* BACKGROUND_BLADE_DENSITY = "background_blade_density";
inline constexpr const char* TERRAIN_MACRO_NOISE_SCALE = "terrain_macro_noise_scale";
inline constexpr const char* TERRAIN_DETAIL_NOISE_SCALE = "terrain_detail_noise_scale";
...
inline constexpr const char* BACKGROUND_SWAY_VARIANCE = "background_sway_variance";
inline constexpr const char* BACKGROUND_SCATTER_RADIUS = "background_scatter_radius";
...
inline constexpr const char* OWNER_ID = "owner_id";
...
inline constexpr const char* WILDLIFE = "wildlife";
inline constexpr const char* WILDLIFE_ENABLED = "enabled";
inline constexpr const char* WILDLIFE_SEED = "seed";
inline constexpr const char* WILDLIFE_NEAR_RADIUS = "near_simulation_radius";
inline constexpr const char* WILDLIFE_FAR_RADIUS = "far_simulation_radius";
inline constexpr const char* WILDLIFE_SHEEP = "sheep";
inline constexpr const char* WILDLIFE_WOLVES = "wolves";
inline constexpr const char* WILDLIFE_BIRDS = "birds";
inline constexpr const char* WILDLIFE_GROUPS = "groups";
inline constexpr const char* WILDLIFE_GROUP_SIZE_MIN = "group_size_min";
inline constexpr const char* WILDLIFE_GROUP_SIZE_MAX = "group_size_max";
inline constexpr const char* WILDLIFE_ROAM_RADIUS = "roam_radius";
inline constexpr const char* WILDLIFE_MOVE_SPEED = "move_speed";
inline constexpr const char* WILDLIFE_FLEE_SPEED = "flee_speed";
inline constexpr const char* WILDLIFE_ALERT_RADIUS = "alert_radius";
inline constexpr const char* WILDLIFE_AGGRESSION = "aggression";
