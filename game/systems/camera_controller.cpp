...
void CameraController::orbit(Render::GL::Camera& camera,
                             float yaw_deg,
                             float pitch_deg) {
...
void CameraController::set_follow_enabled(Render::GL::Camera& camera, bool enable) {
  camera.set_follow_enabled(enable);
}

void CameraController::set_follow_lerp(Render::GL::Camera& camera, float alpha) {
