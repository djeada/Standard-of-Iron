...
public:
  ...
  static auto screen_to_ground(const Render::GL::Camera& camera,
                               int view_w,
                               int view_h,
  ...
  static auto pick_single(float sx,
                          float sy,
                          Engine::Core::World& world,
                          const Render::GL::Camera& camera,
                          int view_w,
  ...
  static auto pick_unit_first(float sx,
                              float sy,
                              Engine::Core::World& world,
                              const Render::GL::Camera& camera,
                              int view_w,
  ...
  static auto pick_in_rect(float x1,
                           float y1,
                           float x2,
                           float y2,
                           Engine::Core::World& world,
