...
inline constexpr float kSpearmanVsCavalryMultiplier = 1.5F;
...
inline constexpr float kHighGroundHealthMultiplier = 1.15F;
inline constexpr float kHighGroundHeightThreshold = 0.5F;
...
inline constexpr float kArrowSpreadMin = -0.8F;
inline constexpr float kArrowSpreadMax = 0.8F;
inline constexpr float kArrowVerticalSpreadFactor = 3.5F;
inline constexpr float kArrowDepthSpreadFactor = 3.0F;
