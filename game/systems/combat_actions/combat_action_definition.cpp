...
constexpr std::array<CombatActionDefinition, 33> k_definitions{{
    ...
    },
    {
        ...
        .authored_clip_id = Animation::k_humanoid_rpg_spear_thrust_clip,
    ...
    },
    {
        ...
        .authored_clip_id = Animation::k_humanoid_rpg_spear_sweep_clip,
        .events = k_rpg_spear_sweep_events,
        .max_targets = 6,
        .commander_only = true,
        .locomotion = ActionLocomotionRequirement::Grounded,
    ...
    },
    {
        ...
        .authored_clip_id = Animation::k_humanoid_rpg_spear_finisher_clip,
        .events = k_rpg_spear_finisher_events,
        .max_targets = 4,
        .commander_only = true,
        .locomotion = ActionLocomotionRequirement::Grounded,
        .role = CommanderActionRole::Finisher,
        .movement = {.distance = 1.75F,
                     .start_normalized = 0.06F,
                     .end_normalized = 0.66F},
        .target_assist = {.acquisition_range = 4.4F,
                          .cone_degrees = 28.0F,
    ...
    },
    {
        ...
        .duration_seconds = 0.88F,
        .authored_clip_id = Animation::k_humanoid_rpg_spear_launcher_clip,
        .events = k_rpg_spear_sweep_events,
        .max_targets = 3,
        .commander_only = true,
        .locomotion = ActionLocomotionRequirement::Grounded,
    ...
    },
    {
        ...
        .locomotion = ActionLocomotionRequirement::Airborne,
        .role = CommanderActionRole::Dive,
        .movement = {.distance = 2.40F,
                     .start_normalized = 0.06F,
                     .end_normalized = 0.66F},
        .target_assist = {.acquisition_range = 4.8F,
                          .cone_degrees = 52.0F,
                          .maximum_turn_degrees = 34.0F,
                          .magnetism_distance = 1.1F},
        .reaction = {.stagger_tier = Engine::Core::StaggerTier::Knockdown,
    ...
    },
    {
        ...
        .duration_seconds = 0.95F,
        .authored_clip_id = Animation::k_humanoid_riding_sword_strike_clip,
    ...
    },
    {
        ...
        .authored_clip_id = Animation::k_humanoid_riding_spear_thrust_clip,
    ...
    },
    {
        ...
        .authored_clip_id = Animation::k_humanoid_riding_charge_clip,
...
auto melee_interruption_at(const CombatActionDefinition& definition,
  ...
  if (t < strike) {
    ...
    bool const settling_into_windup = t < windup;
    return {.phase = settling_into_windup ? MeleePhase::Ready : MeleePhase::Windup,
            .accepts_attack = settling_into_windup,
            .accepts_guard = true,
            .accepts_dodge = true,
