...
### forest_mud (Default)
- **Grass Primary:** Deep green (0.27, 0.52, 0.25)
- **Grass Secondary:** Medium green (0.38, 0.61, 0.29)
- **Grass Dry:** Olive (0.76, 0.70, 0.48)
- **Soil Color:** Dark brown (0.28, 0.24, 0.18)
- **Rock Low:** Gray (0.48, 0.46, 0.44)
- **Rock High:** Light gray (0.68, 0.69, 0.73)

### grass_dry
- **Grass Primary:** Muted olive green (0.27, 0.44, 0.20)
- **Grass Secondary:** Soft olive green (0.38, 0.53, 0.24)
- **Grass Dry:** Dry olive green (0.50, 0.50, 0.27)
- **Soil Color:** Sandy brown (0.52, 0.44, 0.32)
- **Rock Low:** Warm gray (0.62, 0.58, 0.52)
- **Rock High:** Light warm gray (0.78, 0.75, 0.70)

### soil_rocky
- **Grass Primary:** Muted green (0.38, 0.46, 0.27)
...
- **Grass Secondary:** Teal-green (0.36, 0.48, 0.34)
- **Grass Dry:** Cool gray-green (0.50, 0.48, 0.42)
- **Soil Color:** Cool gray (0.42, 0.40, 0.38)
- **Rock Low:** Bluish gray (0.58, 0.60, 0.64)
- **Rock High:** Near white/snow (0.88, 0.90, 0.94)

### soil_fertile
- **Grass Primary:** Rich green (0.24, 0.50, 0.22)
- **Grass Secondary:** Vibrant green (0.32, 0.58, 0.28)
- **Grass Dry:** Olive-brown (0.52, 0.48, 0.32)
- **Soil Color:** Very dark brown (0.20, 0.16, 0.12)
- **Rock Low:** Dark gray (0.38, 0.36, 0.34)
- **Rock High:** Medium gray (0.52, 0.50, 0.48)
