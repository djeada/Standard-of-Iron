...
- `illyrian_coast` - Illyrian Coast (Rome's protectorate on the Dalmatian seaboard)
- `illyria` - Illyrian Interior (the tribes of the hinterland, unclaimed in 218)

`tests/map/campaign_province_data_test.cpp` holds this file, `valid_provinces.json`
and `campaign_state.json` to the ids `provinces.py` actually emits. It was added
