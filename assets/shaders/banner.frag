...
// Fractal brownian motion for cloth texture
float fbm(vec2 p) {
    float value = 0.0;
    float amplitude = 0.5;
    for (int i = 0; i < 3; i++) {
...
void main() {
    ...
    // Cloth folds based on wave deformation - darker in valleys
    ...
    // Wrap lighting for soft cloth appearance
    ...
    // Slight color variation toward bottom (dust/wear)
