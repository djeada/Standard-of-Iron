...
CUES: list[tuple[str, float, str, float]] = [
    ...
    ("form_the_line", 0.20, SFX + "ui/command_accept.ogg", 0.50),
    ("form_the_line", 1.30, SFX + "orders/formation_pole_shift.ogg", 0.60),
    ("form_the_line", 1.90, SFX + "combat/army_march_dirt_mass.ogg", 0.55),
    ("form_the_line", 3.70, SFX + "combat/army_march_dirt_mass.ogg", 0.45),
    ("battle_line", 0.30, SFX + "combat/army_march_dirt_mass.ogg", 0.50),
    ("battle_line", 3.00, SFX + "orders/hold_shields_plant.ogg", 0.70),
    ("battle_line", 4.10, SFX + "orders/formation_standard_planted.ogg", 0.65),
