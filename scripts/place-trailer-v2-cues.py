...
CUES: list[tuple[str, float, str, float]] = [
    ...
    ("command_view", 2.35, SFX + "combat/stone_impact_01.ogg", 0.65),
    ...
    ("scipio_pov", 1.25, SFX + "combat/armour_hit_01.ogg", 0.75),
    ("scipio_pov", 1.60, SFX + "combat/human_death_cry.ogg", 0.70),
    ("scipio_pov", 1.95, SFX + "combat/blade_clash_02.ogg", 0.80),
    ("scipio_pov", 2.40, SFX + "combat/roman_shield_wall_impact.ogg", 0.80),
    ("scipio_pov", 2.75, SFX + "combat/sword_hit_01.ogg", 0.75),
    ("scipio_pov", 3.05, SFX + "combat/arrow_impact_01.ogg", 0.60),
    ("scipio_pov", 3.35, SFX + "combat/human_death_cry_v2.ogg", 0.70),
    ("scipio_pov", 3.70, SFX + "combat/blade_clash_03.ogg", 0.80),
    ("scipio_pov", 4.05, SFX + "combat/armour_hit_02.ogg", 0.72),
    ("scipio_pov", 4.40, SFX + "combat/arrows_overhead_dark.ogg", 0.55),
    ("scipio_pov", 4.75, SFX + "combat/human_death_cry_v3.ogg", 0.70),
    ("scipio_pov", 5.10, SFX + "combat/blade_clash_01.ogg", 0.75),
    ...
    ("sepulcher_battle", 1.00, SFX + "combat/fireball_impact.ogg", 0.85),
    ("sepulcher_battle", 1.45, SFX + "combat/human_death_cry.ogg", 0.70),
    ("sepulcher_battle", 1.85, SFX + "combat/armour_hit_01.ogg", 0.72),
    ("sepulcher_battle", 2.25, SFX + "combat/blade_clash_03.ogg", 0.78),
    ("sepulcher_battle", 2.70, SFX + "combat/fireball_impact.ogg", 0.75),
    ("sepulcher_battle", 3.05, SFX + "combat/human_death_cry_v2.ogg", 0.68),
    ("mage_kill_pov", 0.00, SFX + "combat/battlefield_crowd_chaos.ogg", 0.72),
    ("mage_kill_pov", 0.20, SFX + "combat/fireball_impact.ogg", 0.90),
    ("mage_kill_pov", 0.65, SFX + "combat/blade_clash_01.ogg", 0.82),
    ("mage_kill_pov", 1.05, SFX + "combat/human_death_cry_v3.ogg", 0.72),
    ("mage_kill_pov", 1.45, SFX + "combat/armour_hit_02.ogg", 0.75),
    ("mage_kill_pov", 1.85, SFX + "combat/fireball_impact.ogg", 0.80),
    ("mage_kill_pov", 2.30, SFX + "combat/sword_hit_01.ogg", 0.78),
    ("mage_kill_pov", 2.70, SFX + "combat/human_death_cry.ogg", 0.70),
    ("mage_kill_pov", 3.10, SFX + "combat/blade_clash_02.ogg", 0.80),
    ("mage_kill_pov", 3.55, SFX + "combat/fireball_impact.ogg", 0.85),
    ("mage_kill_pov", 4.00, SFX + "combat/armour_hit_01.ogg", 0.72),
    ("mage_kill_pov", 4.40, SFX + "combat/human_death_cry_v2.ogg", 0.72),
    ("mage_kill_pov", 4.80, SFX + "combat/blade_clash_03.ogg", 0.78),
    ("mage_kill_pov", 5.25, SFX + "combat/fireball_impact.ogg", 0.80),
    ("mage_kill_pov", 5.70, SFX + "combat/soldiers_victory_cheer.ogg", 0.60),
