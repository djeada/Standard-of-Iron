...
CUES: list[tuple[str, float, str, float]] = [
    ...
    ("storm_charge", 0.70, SFX + "combat/horse_gallop_close_pass.ogg", 0.85),
    ...
    ("consuls_duel", 1.90, SFX + "combat/blade_clash_02.ogg", 0.82),
    ("pov_wade", 0.20, SFX + "combat/blade_clash_03.ogg", 0.85),
