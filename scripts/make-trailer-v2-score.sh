...
# cut: the town at 34.5 s, the Iron Sepulcher at 44.6 s, the editor at 58.9 s
# and the fire end card at 61.4 s. The fanfare lands on the card.
#
...
# before it ends, so the joins sit at 15.7, 34.5, 44.6, 58.9 and 61.4 s -- the
...
[2:a]atrim=6:17.57,asetpts=PTS-STARTPTS,volume=0.95[s3];\
...
[j5]atrim=0:66.9,asetpts=PTS-STARTPTS,afade=t=out:st=64.4:d=2.5[mix]" \
