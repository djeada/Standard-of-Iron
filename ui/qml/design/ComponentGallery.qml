...
ScrollView {
    ...
    Column {
        ...
        Text {
            text: qsTr("Iron and Ember Components")
        ...
        Row {
            ...
            Controls.IronHotkeyLabel {
                text: "Ctrl+S"
            }
            Controls.IronResourceCounter {
                iconText: "\u25C8"
                amount: 1250
                trend: 12
            }
        }
        Controls.IronSearchField {
            width: 300
        }
