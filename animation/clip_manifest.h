...
inline constexpr std::uint16_t k_humanoid_idle_plant_flag_clip = 5U;

inline constexpr std::uint16_t k_humanoid_walk_clip = 6U;
inline constexpr std::uint16_t k_humanoid_run_clip = 7U;
inline constexpr std::uint16_t k_humanoid_hold_clip = 8U;
inline constexpr std::uint16_t k_humanoid_hold_bow_clip = 9U;
inline constexpr std::uint16_t k_humanoid_attack_sword_a_clip = 10U;
inline constexpr std::uint16_t k_humanoid_attack_sword_b_clip = 11U;
inline constexpr std::uint16_t k_humanoid_attack_sword_c_clip = 12U;
inline constexpr std::uint16_t k_humanoid_attack_spear_a_clip = 13U;
inline constexpr std::uint16_t k_humanoid_attack_spear_b_clip = 14U;
inline constexpr std::uint16_t k_humanoid_attack_spear_c_clip = 15U;
inline constexpr std::uint16_t k_humanoid_attack_bow_clip = 16U;
inline constexpr std::uint16_t k_humanoid_riding_idle_clip = 17U;
inline constexpr std::uint16_t k_humanoid_riding_charge_clip = 18U;
inline constexpr std::uint16_t k_humanoid_riding_reining_clip = 19U;
...
inline constexpr std::uint16_t k_humanoid_construct_chisel_clip = 65U;
...
inline constexpr std::uint8_t k_humanoid_idle_variant_count = 6U;
