...
ArenaWindow::ArenaWindow(QWidget* parent)
  ...
  connect(reset_camera_action,
          &QAction::triggered,
          m_viewport,
          &ArenaViewport::reset_camera);
  connect(
      pause_action, &QAction::toggled, m_viewport, &ArenaViewport::pause_simulation);
  connect(
      m_viewport, &ArenaViewport::paused_changed, pause_action, &QAction::setChecked);
  connect(m_viewport,
          &ArenaViewport::paused_changed,
          m_unit_panel,
  ...
  connect(m_terrain_panel,
          &TerrainPanel::height_scale_changed,
          m_viewport,
  ...
  connect(m_terrain_panel,
          &TerrainPanel::frequency_changed,
          m_viewport,
  ...
  connect(m_terrain_panel,
          &TerrainPanel::ground_type_changed,
          m_viewport,
          &ArenaViewport::set_ground_type);
  connect(m_terrain_panel,
          &TerrainPanel::rain_toggled,
          m_viewport,
  ...
  connect(m_unit_panel,
          &UnitPanel::spawn_owner_selected,
          m_viewport,
          &ArenaViewport::set_spawn_owner);
  connect(m_unit_panel,
          &UnitPanel::nation_selected,
          m_viewport,
          &ArenaViewport::set_spawn_nation);
  connect(m_unit_panel,
          &UnitPanel::unit_type_selected,
          m_viewport,
          &ArenaViewport::set_spawn_unit_type);
  connect(m_unit_panel,
          &UnitPanel::spawn_individuals_per_unit_changed,
          m_viewport,
  ...
  connect(m_unit_panel,
          &UnitPanel::apply_visual_overrides_requested,
          m_viewport,
          &ArenaViewport::apply_visual_overrides_to_selection);
  connect(m_unit_panel,
          &UnitPanel::spawn_opposing_batch_requested,
          m_viewport,
          &ArenaViewport::spawn_opposing_batch);
  connect(m_unit_panel,
          &UnitPanel::spawn_mirror_match_requested,
          m_viewport,
  ...
  connect(m_unit_panel,
          &UnitPanel::movement_speed_changed,
          m_viewport,
  ...
  connect(m_building_panel,
          &BuildingPanel::spawn_buildings_requested,
          m_viewport,
          &ArenaViewport::spawn_buildings);
  connect(m_building_panel,
          &BuildingPanel::clear_buildings_requested,
          m_viewport,
          &ArenaViewport::clear_buildings);
  connect(m_building_panel,
          &BuildingPanel::building_owner_selected,
          m_viewport,
          &ArenaViewport::set_spawn_building_owner);
  connect(m_building_panel,
          &BuildingPanel::building_nation_selected,
          m_viewport,
          &ArenaViewport::set_spawn_building_nation);
  connect(m_building_panel,
          &BuildingPanel::building_type_selected,
          m_viewport,
          &ArenaViewport::set_spawn_building_type);
  connect(m_viewport,
          &ArenaViewport::selection_summary_changed,
          m_building_panel,
          &BuildingPanel::set_selection_summary);

  connect(m_prop_panel,
          &PropPanel::world_prop_type_selected,
          m_viewport,
          &ArenaViewport::set_spawn_world_prop_type);
  connect(m_prop_panel,
          &PropPanel::world_prop_scale_changed,
          m_viewport,
          &ArenaViewport::set_spawn_world_prop_scale);
  connect(m_prop_panel,
          &PropPanel::world_prop_rotation_degrees_changed,
          m_viewport,
          &ArenaViewport::set_spawn_world_prop_rotation_degrees);
  connect(m_prop_panel,
          &PropPanel::fire_camp_intensity_changed,
          m_viewport,
          &ArenaViewport::set_spawn_fire_camp_intensity);
  connect(m_prop_panel,
          &PropPanel::fire_camp_radius_changed,
          m_viewport,
  ...
  connect(m_prop_panel,
          ...
          m_viewport,
          &ArenaViewport::clear_world_props_of_type);
  ...
  m_viewport->set_spawn_fire_camp_radius(m_prop_panel->selected_fire_camp_radius());
}
