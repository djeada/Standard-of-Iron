...
inline constexpr char k_rpg_motor_start_stop_id[] = "rpg_motor_start_stop";
inline constexpr char k_rpg_motor_diagonal_id[] = "rpg_motor_diagonal";
inline constexpr char k_rpg_motor_figure_eight_id[] = "rpg_motor_figure_eight";
...
inline constexpr char k_rpg_camera_prop_gauntlet_id[] = "rpg_camera_prop_gauntlet";
inline constexpr char k_rpg_camera_wall_pocket_id[] = "rpg_camera_wall_pocket";
inline constexpr char k_rpg_camera_hill_bank_id[] = "rpg_camera_hill_bank";
...
inline constexpr char k_path_narrow_gap_column_id[] = "path_narrow_gap_column";
inline constexpr char k_traversal_city_street_id[] = "traversal_city_street";
inline constexpr char k_traversal_city_alley_id[] = "traversal_city_alley";
inline constexpr char k_traversal_wide_street_id[] = "traversal_wide_street";
inline constexpr char k_traversal_wall_gate_id[] = "traversal_wall_gate";
inline constexpr char k_traversal_forest_path_id[] = "traversal_forest_path";
inline constexpr char k_traversal_hill_gap_id[] = "traversal_hill_gap";
inline constexpr char k_traversal_rock_cluster_id[] = "traversal_rock_cluster";
inline constexpr char k_traversal_ruins_field_id[] = "traversal_ruins_field";
inline constexpr char k_traversal_open_ground_id[] = "traversal_open_ground";
...
inline constexpr char k_path_hill_entrance_column_id[] = "path_hill_entrance_column";
...
inline constexpr char k_massed_battle_250_id[] = "massed_battle_250";
...
inline constexpr char k_massed_battle_2000_id[] = "massed_battle_2000";
...
inline constexpr char k_ai_kingdom_rise_id[] = "ai_kingdom_rise";
...
inline constexpr char k_imperial_capital_id[] = "promo_imperial_capital";
