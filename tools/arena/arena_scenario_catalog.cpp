...
auto definitions() -> const std::vector<ArenaScenarioDefinition>& {
  static const std::vector<ArenaScenarioDefinition> catalog = [] {
    ...
    auto stuck_recovery = build_stuck_recovery_definitions();
    values.insert(values.end(),
    ...
    auto economy = build_economy_definitions();
    values.insert(values.end(),
                  std::make_move_iterator(economy.begin()),
                  std::make_move_iterator(economy.end()));
