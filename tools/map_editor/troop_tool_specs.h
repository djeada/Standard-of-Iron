...
inline constexpr std::array<TroopToolSpec, 21> k_troop_tool_specs{{
    ...
    {ToolType::TroopRomanFieldCommander,
     ...
     "Command"},
    {ToolType::TroopCarthageSpearCommander,
     "carthage_spear_commander",
     "Hanno the Great",
     "Place Hanno the Great (Carthaginian spear commander) spawns.",
     "Command"},
    {ToolType::TroopCarthageBowCommander,
     "carthage_bow_commander",
     "Hasdrubal Barca",
     "Place Hasdrubal Barca (Carthaginian bow commander) spawns.",
     "Command"},
    {ToolType::TroopCarthageSwordCommander,
     "carthage_sword_commander",
     "Hannibal Barca",
     "Place Hannibal Barca (Carthaginian sword commander) spawns.",
     "Command"},
