...
public:
  explicit SelectionQueryService(Engine::Core::World* world, QObject* parent = nullptr);

  [[nodiscard]] QString get_selected_units_command_mode() const;
  [[nodiscard]] QString get_selected_units_toggle_state(const QString& mode) const;
