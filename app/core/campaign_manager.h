...
public:
  ...
  void
  configure_mission_victory_conditions(Game::Systems::VictoryService* victory_service,
                                       int local_owner_id);

  [[nodiscard]] const Game::Mission::MissionContext& current_mission_context() const {
