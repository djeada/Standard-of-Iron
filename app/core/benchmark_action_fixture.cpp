...
auto action_names() -> QStringList {
  return {QStringLiteral("select_all"),
          ...
          QStringLiteral("divide_squads"),
          QStringLiteral("merge_squads"),
          QStringLiteral("objectives_panel"),
          ...
          QStringLiteral("camera_move"),
          QStringLiteral("camera_zoom"),
          QStringLiteral("camera_orbit"),
          QStringLiteral("camera_follow"),
          QStringLiteral("game_speed"),
          ...
          QStringLiteral("build_cancel"),
          QStringLiteral("commander_enter"),
          QStringLiteral("commander_exit"),
          QStringLiteral("commander_aura"),
          QStringLiteral("commander_rally_at"),
          QStringLiteral("commander_key_down"),
          QStringLiteral("commander_key_up"),
          QStringLiteral("commander_attack"),
          QStringLiteral("commander_heavy"),
          QStringLiteral("commander_special"),
          QStringLiteral("commander_vanguard"),
          ...
          QStringLiteral("hover_at_world"),
          QStringLiteral("deselect_world"),
          QStringLiteral("set_rally_world"),
          QStringLiteral("formation_begin_world"),
          QStringLiteral("formation_drag_world"),
          QStringLiteral("build_start_world"),
          QStringLiteral("build_hover_world"),
          QStringLiteral("build_place_world"),
          QStringLiteral("commander_rally_at_world")};
}
