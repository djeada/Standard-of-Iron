...
public:
  ...
  Q_INVOKABLE void on_minimap_left_click(qreal mx, qreal my, qreal minimap_width, qreal minimap_height);
  Q_INVOKABLE void on_minimap_right_click(qreal mx, qreal my, qreal minimap_width, qreal minimap_height);
